...
filename = "origsize24clrgrp"

directory = "videos/giraffe"
...
if len(sys.argv) > 1:
   ...
   print("execute script combine_rpt_ptn_shapes_wk.py. filename " + filename + " directory " + directory )
...
for rpt_ptn_shape in rpt_ptn_shapes_w_clrs:
   ...
   for rpt_ptn_shapeid, rpt_ptn_shapeids_w_color in rpt_ptn_shape.items():
      rpt_ptn_shapes_wk[rpt_ptn_shapeid] = []
      ...
      rpt_ptn_shapes_wk[rpt_ptn_shapeid] += same_colors
...
for rpt_ptn_shapeid, rpt_ptn_colors in rpt_ptn_shapes_wk.items():
   ...
   for ano_rpt_ptn_shapeid, ano_rpt_ptn_colors in rpt_ptn_shapes_wk.items():
      if rpt_ptn_shapeid == ano_rpt_ptn_shapeid or ano_rpt_ptn_shapeid in already_added_rpt_ptn:
         # itself
         continue
      ...
      for rpt_ptn_color in rpt_ptn_colors:
         ...
         for ano_rpt_ptn_color in ano_rpt_ptn_colors:
            ...
            if not clr_ch and brit_thres:
               ...
               # current ano_rpt_ptn_color with current rpt_ptn_color. go to next rpt_ptn_color
               break
      ...
      if cur_rpt_ptn_match:
         ...
         already_added_rpt_ptn.append( ano_rpt_ptn_shapeid )
         ...
         for ano_shapeid_w_clrs in ano_rpt_ptn_colors:
