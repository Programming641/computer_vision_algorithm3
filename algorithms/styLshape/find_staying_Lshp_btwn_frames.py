...
if shapes_type == "normal":
   ...
   im1shapes_locations_path = s_pixcShp_intnl_loc_dir + filename1 + "_loc.data"   
   im2shapes_locations_path = s_pixcShp_intnl_loc_dir + filename2 + "_loc.data"  
   ...
   for shapeid in im1shapes:
      ...
      for xy in im1shapes_boundaries[shapeid]:
         ...
         cur_pixel_indexes.add( str(pindex) )
