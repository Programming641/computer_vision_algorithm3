...
for file1_2names in all_btwn_frames_files:
   ...
   for im1_n2_nbrs_shapeid in all_btwn_frames_files[ file1_2names ]:
      ...
      im1shapes_file = styLshapes_w_neighbors_dir + first_filenum + "." + second_filenum + "/" + im1_n2_nbrs_shapeid + "im1.png" 
      im2shapes_file = styLshapes_w_neighbors_dir + first_filenum + "." + second_filenum + "/" + im1_n2_nbrs_shapeid + "im2.png" 
      ...
      image_functions.cr_im_from_shapeslist2( first_filenum, directory, im1shapes, save_filepath=im1shapes_file , shapes_rgb=( 255, 0, 0 ) )   
