...
scnd_stage_alg_shpDir = top_shapes_dir + directory + snd_stg_alg_shp_nbrs_dir + "/"

image_dir = scnd_stage_alg_shpDir + im1file + "." + im2file + "/"
...
scnd_stage_alg_shp_dfile = scnd_stage_alg_shpDir + im1file + "." + im2file + ".data"
