...
filename = "easy image to analyze for practice3"
...
def get_closest_color(image_pixel):
    ...
    file = open("C:\\Users\Taichi\Documents\data\list of colors2.txt")
...
original_image.save("images/" + directory + filename + "_color_group.png")
