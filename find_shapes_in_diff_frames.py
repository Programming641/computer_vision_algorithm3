...
filename = "hanger004_color_group"

directory = ""

filename2 = "hanger005_color_group"
...
for original_shape_id in original_shapeIDs_with_all_indexes:
   ...
   for compare_shape_id in compare_shapeIDs_with_all_indexes:
      ...
      if shape_ids[0] == 26720 and shape_ids[1] == 38838:
         ...
         boundary_result = 0
         boundary_result = video_algorithms.process_boundaries(original_boundary_pixels, compare_boundary_pixels, shape_ids, filenames)
         result = 0
