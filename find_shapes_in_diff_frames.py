...
filename = "hanger005_color_group"

directory = ""

filename2 = "hanger006_color_group"
...
for original_shape_id in original_shapeIDs_with_all_indexes:
   ...
   for compare_shape_id in compare_shapeIDs_with_all_indexes:
      ...
      both_near = pixel_shapes_functions.are_shapes_near(filename, filename2, directory, original_shapeIDs_with_all_indexes[original_shape_id], \
                     compare_shapeIDs_with_all_indexes[compare_shape_id] , shape_ids  )
      ...
      boundary_rel_result = same_shapes_btwn_frames.boundary_rel_pos(original_boundary_pixels, compare_boundary_pixels, shape_ids)
      
      boundary_result = 0
      boundary_result = same_shapes_btwn_frames.process_boundaries(original_boundary_pixels, compare_boundary_pixels, shape_ids, filenames)
      result = 0
      result = same_shapes_btwn_frames.find_shapes_in_diff_frames(original_shapeIDs_with_all_indexes[original_shape_id], compare_shapeIDs_with_all_indexes[compare_shape_id],  "consecutive_count", shape_ids)
