...
def get_shapeid_frompix(image_index, image_filename, im_dir, shapes_type):
   if shapes_type == "normal":
      print("pixel_shapes_functions.get_shapeid_frompix. shapes_type normal not implemented yet")
      sys.exit()
   
   elif shapes_type == "intnl_spixcShp":
      s_pixcShp_intnl_dir = top_shapes_dir + im_dir + "spixc_shapes/" + internal + "/"
      ...
      for shapeid in im_shapes:
         if image_index in im_shapes[shapeid]:
            return shapeid
...
# {(231, 63), (244, 82), ... }
# { ( x, y ), ( x, y ), ... }
def get_shape_vicinity_pixels( shape_boundary, vicinity_value, image_size, param_shp_type=1 ):
   vicinity_pixels = set() 
